...
const authors = [
  ...
  { id: 3, name: 'Елена «Pixel» Волкова', bio: 'Обозреватель. Отвечает за обзоры новых игр и ретроспективы культовых проектов. Любит находить скрытые жемчужины.' },
  { id: 4, name: 'Иван «Retro» Морозов', bio: 'Специалист по инди-играм и альтернативной сцене. Следит за новинками в itch.io и Steam.' },
