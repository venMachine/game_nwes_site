...
const { data: articles, pending } = await useFetch(
  `${config.public.apiBaseUrl}/articles?category=consoles&limit=50`
)


useSeoMeta({
  title: 'BarracudaGame - Игры и консоли',
  description: 'Новости игр, консолей и игровой индустрии',
  ogTitle: 'BarracudaGame - Игры и консоли',
  ogDescription: 'Свежие новости о новых играх и консолях',
